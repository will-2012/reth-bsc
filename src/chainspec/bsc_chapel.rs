...
pub fn head() -> Head {
    Head { number: 57_638_970, hash: B256::from_str("0x74e802362fb536395ef7d9d82a87631d5fffaa584a891999d5e77b91bda33754").unwrap(), difficulty: U256::from(2), total_difficulty: U256::from(115_030_996), timestamp: 1752059605, ..Default::default() }
}